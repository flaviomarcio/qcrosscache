...
public:
    ...
    //! \param command
    //!
    explicit ActuatorMemcachedRequest(const QByteArray &hostName,
                                      const int portNumber,
                                      const QByteArray &reqBody)
        : QThread{nullptr}
    {
    ...
    QVector<QByteArray> responseBody() const { return this->resBody; }
...
private slots:
    ...
    void call()
    {
        ...
        QObject::connect(m_socket,
                         ...
                         this,
                         &ActuatorMemcachedRequest::onReplyError);
#else
        QObject::connect(m_socket,
        ...
        QObject::connect(m_socket,
                         ...
                         this,
                         &ActuatorMemcachedRequest::onConnected);
