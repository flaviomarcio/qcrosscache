...
void QCrossCache::CacheRequest::run()
{
    QObject::connect(this,
                     &CacheRequest::repositoryCacheClear,
                     this->repository,
                     &CacheRepository::cacheClear);
    QObject::connect(this,
                     &CacheRequest::repositoryCacheGet,
                     this->repository,
                     &CacheRepository::cacheGet);
    QObject::connect(this,
                     &CacheRequest::repositoryCacheList,
                     this->repository,
                     &CacheRepository::cacheList);
    QObject::connect(this,
                     &CacheRequest::repositoryCacheListKeys,
                     this->repository,
                     &CacheRepository::cacheListKeys);
    QObject::connect(this,
                     &CacheRequest::repositoryCachePut,
                     this->repository,
                     &CacheRepository::cachePut);
    QObject::connect(this,
                     &CacheRequest::repositoryCacheRemove,
                     this->repository,
                     &CacheRepository::cacheRemove);
    QObject::connect(this,
                     &CacheRequest::repositoryCacheTake,
                     this->repository,
                     &CacheRepository::cacheTake);
...
void QCrossCache::CacheRequest::onCachePut(const QByteArray &key,
